...
public class Queries {
    ...
    private static void createDocs(RAMDirectory ramDir, Analyzer analyzer) throws IOException {
    ...
    private static void indexDoc(IndexWriter writer, String name, String content) throws IOException {
    ...
    private static void queryDocs(RAMDirectory ramDir, Analyzer analyzer) throws IOException, ParseException {
        ...
        for (ScoreDoc scoreDoc : foundDocs.scoreDocs) {
            ...
            System.out.println("Name: " + document.get("name") + " - Body: " + document.get("body") + " - Score: " + scoreDoc.score);
        }
